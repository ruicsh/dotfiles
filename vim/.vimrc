...
function! SetAllHighlightsWhite()
  for group in getcompletion('', 'highlight')
    execute 'highlight ' . group . ' guifg=#D8DEE9'
  endfor
endfunction

:call SetAllHighlightsWhite()
...
highlight SignColumn guifg=#D8DEE9 guibg=#2E3440 
...
highlight StatusLine guifg=#D8DEE9 guibg=NONE
