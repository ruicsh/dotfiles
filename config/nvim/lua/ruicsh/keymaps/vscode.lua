...
-- tabs
vim.keymap.set("n", "<bs>", ac("workbench.action.openPreviousRecentlyUsedEditor"))
...
vim.keymap.set("n", "<leader>bl", ac("workbench.action.showAllEditors"))
vim.keymap.set("n", "<s-bs>", ac("workbench.action.openNextRecentlyUsedEditor"))
