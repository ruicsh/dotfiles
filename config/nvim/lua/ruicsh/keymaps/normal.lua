...
-- registers
k("n", "C", '"_C') -- change to end of line without putting it into register
k("n", "c", '"_c') -- change text without putting it into register
k("n", "cc", '"_cc') -- change line without putting it into register
k("n", "x", '"_x') -- don't yank on delete char under cursor
k("n", "X", '"_X') -- don't yank on delete char before cursor
